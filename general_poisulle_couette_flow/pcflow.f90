!LBM code for a general poisuelle_couette flow system
...
double precision:: temp1, temp2, omega, rho_n, ut
integer:: i, j, k, t, steps = 50000
double precision:: nu, dx = 1.0d0, dy = 1.0d0, dt = 1.0d0, rho0 = 1.0d0, tau = 1.00d0, dpdx = 1.0e-4, t1, t2, t3, t4, s, sx, sy
...
do j = 0, m
	uexact(j) = (-0.50d0 * dpdx * ((j * j) - (m * j)) / nu) + (j * ut / m)
end do

open(17, file = 'uv_field2.txt')
open(27, file = 'u_prof2.txt')
